...
//                     <button onClick={toggleEmojiPicker} ref={emojiRef}  className='text-yellow-500 focus:border-none focus:outline-none focus:text-white duration-300 transition-all ' >
